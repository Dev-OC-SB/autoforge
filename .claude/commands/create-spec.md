...
**Output location:** `$ARGUMENTS/.seaforge/prompts/app_spec.txt` and `$ARGUMENTS/.seaforge/prompts/initializer_prompt.md`
...
The output directory is: `$ARGUMENTS/.seaforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `$ARGUMENTS/.seaforge/prompts/app_spec.txt`
...
**Output path:** `$ARGUMENTS/.seaforge/prompts/initializer_prompt.md`
...
**Output path:** `$ARGUMENTS/.seaforge/prompts/.spec_status.json`
...
```json
{
  ...
  "files_written": [
    ".seaforge/prompts/app_spec.txt",
    ".seaforge/prompts/initializer_prompt.md"
  ],
...
```json
{
  ...
  "files_written": [
    ".seaforge/prompts/app_spec.txt",
    ".seaforge/prompts/initializer_prompt.md",
    ".seaforge/prompts/coding_prompt.md"
  ],
  "feature_count": 35
}
```
...
> "Your specification files have been created in `$ARGUMENTS/.seaforge/prompts/`!
>
> **Files created:**
> - `$ARGUMENTS/.seaforge/prompts/app_spec.txt`
> - `$ARGUMENTS/.seaforge/prompts/initializer_prompt.md`
>
