...
def main() -> None:
    """Main entry point."""
    parser = argparse.ArgumentParser(description="SeaForge UI Launcher")
    ...
    if host != "127.0.0.1":
        ...
        print("  The SeaForge UI will be accessible from other machines.")
